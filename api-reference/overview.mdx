...
description: Read and update Inrepli contacts and companies with the API 1.1 contract.
---

The Inrepli REST API connects your applications to an existing workspace. API 1.1 uses the `/v1` URL prefix and exposes eight operations.
