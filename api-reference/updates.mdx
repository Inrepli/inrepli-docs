...
Emails are trimmed and lowercased, mobile numbers require E.164, and company websites use the public `websiteUrl` field. Owner and company references must belong to the same workspace. Custom fields are validated and saved with the native changes in one transaction.
