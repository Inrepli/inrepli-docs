...
| 409 | Conflicting identity or reused idempotency key | Inspect the error code; resolve the conflict |
| 412 | Stale ETag | Read, reconcile and submit a new logical update |
| 422 | Invalid native/custom field or related reference | Correct the supplied value |
